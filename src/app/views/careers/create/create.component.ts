  ...
  addCareer(values: ICareers) {
      if(this.checkBasicDetailsFilled() && this.checkContentFilled() && this.checkPublishingInfoFilled()){
        ...
        const data: ICareers = {
          ...
          this.apiService.ExecutePost(this.apiService.baseUrl + ApiConstant.addCareer, data)
          .pipe(takeUntil(this.unsubscribe))
          .subscribe((response: any) => {
            this.toastr.success("", "The Career has been created successfully", {
            ...
            this.toastr.error('Failed to create the career', error?.error, {
              timeOut: 3000,closeButton:true,easing : "ease-in-out",
              titleClass: "tstr-title",
              messageClass: "tstr-message",
            });
